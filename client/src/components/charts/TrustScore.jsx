  ...
  return (
    <div className="border border-stone-200 bg-blue-950 p-6 text-white shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-sm font-semibold uppercase text-blue-200">Trust Score</p>
          <h3 className="mt-2 text-2xl font-semibold">Credential Integrity</h3>
        </div>
        <span className="bg-white/10 px-3 py-1 text-xs font-semibold text-blue-50">Blockchain-backed</span>
      </div>
